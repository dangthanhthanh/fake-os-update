...
export const Windows81Update: FC<Props> = ({ progress, customMessage, showPercentage }) => {
  return (
    <div className="w-full h-full bg-[#0078d7] text-white flex items-center justify-center font-['Segoe_UI_Light',_'Segoe_UI',_sans-serif]">
